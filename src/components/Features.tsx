...
import { Activity, Shield, HardHat, Zap, ArrowRight, Box, Truck, Code, CheckCircle, Rocket, Factory, Microchip, Handshake, RefreshCcw, MessageSquare, Book, BookOpen, Users, Calendar } from "lucide-react";
...
const Features = () => {
  ...
  const features = [
    {
      ...
      description: "Accédez à des milliers d'ouvrages, revues et ressources numériques organisés par catégories et facilement consultables.",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&h=600&fit=crop"
    },
    {
      icon: <Users className="w-10 h-10 text-white transition-transform duration-300 transform" />,
      title: "Gestion des Membres",
      description: "Système complet de gestion des adhérents avec suivi des emprunts, historique et notifications automatiques.",
      image: "https://images.unsplash.com/photo-1521587760476-6c12a4b040da?w=800&h=600&fit=crop"
    },
    {
      icon: <Calendar className="w-10 h-10 text-white transition-transform duration-300 transform" />,
      title: "Réservations",
      description: "Réservez vos ouvrages préférés en ligne et recevez des notifications lorsqu'ils sont disponibles.",
    ...
    },
    {
      ...
      description: "Accès 24h/24 aux livres électroniques, audiolivres et bases de données spécialisées.",
  ...
  const libraryServices = [{
    ...
    description: "Espaces de lecture silencieux et collaboratifs équipés de Wi-Fi et prises électriques pour tous vos besoins."
  }, {
    image: "https://images.unsplash.com/photo-1521587760476-6c12a4b040da?w=600&h=400&fit=crop",
    title: "Assistance Numérique",
    description: "Support technique et formation aux outils numériques pour tirer le meilleur parti de nos ressources."
  }, {
    image: "https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=600&h=400&fit=crop",
    title: "Collections Spécialisées",
    description: "Fonds documentaires spécialisés par domaine avec assistance de bibliothécaires experts."
  }];

  const managementSteps = [{
    icon: <Book className="h-10 w-10 text-gray-700" />,
    title: "Catalogage Intelligent",
    description: "Système de classification automatique et recherche sémantique"
  }, {
    icon: <Users className="h-10 w-10 text-gray-700" />,
    title: "Interface Utilisateur",
    description: "Portail en ligne intuitif pour tous les services bibliothèque"
  }, {
    icon: <Calendar className="h-10 w-10 text-gray-700" />,
    title: "Gestion Automatisée",
    description: "Automatisation des emprunts, retours et notifications"
  }];
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8" ref={featuresRef}> 
          <div className="text-center mb-10 max-w-3xl mx-auto feature-item">
            ...
            <p className="text-gray-600 mt-4">
              Notre bibliothèque moderne vous offre une gamme complète de services numériques et traditionnels pour enrichir votre expérience de lecture et de recherche.
            </p>
          </div>
          ...
          <div className="mt-16 mb-8 feature-item">
            <div className="text-center mb-8">
              <div className="inline-block mb-2 px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm font-medium">
                Nos Espaces et Services
              </div>
              <h3 className="text-2xl font-bold">Un Environnement Adapté à Vos Besoins</h3>
              <p className="text-gray-600 mt-3 max-w-2xl mx-auto">
                Découvrez nos différents espaces et services conçus pour optimiser votre expérience de lecture et de recherche.
                <span className="block text-sm mt-1 text-blue-500">Faites défiler horizontalement pour voir plus d'espaces →</span>
              </p>
            </div>
            ...
            <div className="rounded-xl overflow-hidden bg-white p-4 feature-item">
              <Carousel className="w-full max-w-7xl mx-auto">
                <CarouselContent className="flex">
                  {libraryServices.map((service, index) => <CarouselItem key={index} className="md:basis-1/3 flex-shrink-0">
                      <Card className="border border-gray-100 shadow-md">
                        <CardContent className="p-0">
                          <div className="w-full h-full">
                            <img src={service.image} alt={service.title} className="w-full h-auto object-contain grayscale" />
                          </div>
                          <div className="p-4">
              ...
              <div className="text-center mt-6 text-sm text-gray-600">
                <p className="font-medium">Ces espaces illustrent notre engagement à créer un environnement d'apprentissage moderne et accueillant</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="technology" className="bg-gray-50 py-10 md:py-16">
        <div className="w-full px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold mb-4">Comment fonctionne notre système</h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
              Notre système de gestion bibliothécaire moderne combine catalogage intelligent, interface utilisateur 
              intuitive et gestion automatisée pour offrir une expérience optimale.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-8 mb-10 transition-all duration-300 hover:shadow-xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
              {managementSteps.map((item, index) => <HoverCard key={index}>
                  ...
                  <HoverCardContent className="w-80 shadow-lg">
                    <div className="space-y-2">
                      ...
                      {index === 0 && <p className="text-xs text-gray-500">Classification automatique et métadonnées enrichies pour une recherche optimale.</p>}
                      {index === 1 && <p className="text-xs text-gray-500">Interface web responsive accessible depuis tous les appareils.</p>}
                      {index === 2 && <p className="text-xs text-gray-500">Notifications automatiques et rappels pour une gestion efficace.</p>}
                    </div>
                  </HoverCardContent>
                </HoverCard>)}
            </div>
              ...
              <div className="max-w-3xl mx-auto">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3 gap-2">
                  <div className="flex items-center">
                    <h3 className="text-xl font-bold">Cycle de Service</h3>
                  </div>
                  <div className="flex items-center">
                    <span className="text-sm text-gray-500 mr-2">Processus Continu</span>
                    <RefreshCcw className="h-5 w-5 text-gray-600 animate-rotate-slow" />
                  </div>
                </div>
                
                <p className="text-gray-600 mb-4">De la recherche au retour, un processus fluide et intuitif</p>
                ...
                <div className={cn("grid gap-1 mt-4", isMobile ? "grid-cols-2 gap-y-2" : "grid-cols-4")}>
                  {servicePhases.map((phase, index) => <div key={index} className={cn("text-center p-2 rounded transition-all", progressValue >= index / servicePhases.length * 100 && progressValue < (index + 1) / servicePhases.length * 100 ? "bg-blue-50 border border-blue-100" : "bg-gray-50")}>
                      <div className="flex flex-col items-center">
                        <div className={cn("rounded-full p-1 mb-1", progressValue >= index / servicePhases.length * 100 ? "bg-blue-100 text-blue-700" : "bg-gray-100 text-gray-500")}>
                          {phase.icon}
                        </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-6 gap-2">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-gray-600">Expérience utilisateur optimisée</span>
                  </div>
                  <div className="text-sm text-gray-500 flex items-center mt-2 sm:mt-0">
                    <span className="mr-2">Service continu</span>
            ...
            <div className="bg-gradient-to-r from-gray-100 via-white to-gray-100 rounded-lg p-8 max-w-xl mx-auto text-center shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-xl font-bold mb-2">Service Optimal</h3>
              <p className="text-gray-700">Une bibliothèque moderne au service de tous</p>
